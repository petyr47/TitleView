...
class TitleView @JvmOverloads constructor(context: Context, attrs : AttributeSet?= null) : FrameLayout(context, attrs) {
    ...
    init {
        ...
        attrs?.let {
            ...
            backgroundFrameColor = attrsSet.getColor(R.styleable.TitleView_backgroundColor, ContextCompat.getColor(context, android.R.color.black))
            textColor = attrsSet.getColor(R.styleable.TitleView_textColor, ContextCompat.getColor(context, android.R.color.white))
